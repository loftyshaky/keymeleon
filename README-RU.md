...
**Безрамочный оконный режим** - Удалите рамки любого окна, сделав его безрамочным.

![settings_window](screenshots/settings_window_ru.png)

## Содержание

- [Системные требования](#системные-требования)
- [Быстрый старт](#быстрый-старт)
- [Графический интерфейс настроек](#графический-интерфейс-настроек)
...
Все описанные ниже параметры можно изменить через графический интерфейс настроек. Чтобы открыть его, щёлкните правой кнопкой мыши по значку Keymeleon в системном трее и выберите `Настройки` в контекстном меню.

После изменения настроек нажмите кнопку `⟳` в верхней части окна, чтобы применить их.
...
| `hide_taskbar`                                              | `Number` | Скрывать панель задач, когда целевое окно в фокусе.                                                                                                                                                                                                                                                                                                                                     | `1`                               | `0`          |
