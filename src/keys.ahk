keys := ["sc029", "sc002", "sc003", "sc004", "sc005", "sc006", "sc007", "sc008", "sc009", "sc00A", "sc00B", "sc00C",
    "sc00D", "sc010", "sc011", "sc012", "sc013", "sc014", "sc015", "sc016", "sc017", "sc018", "sc019", "sc01A", "sc01B",
    "sc02B", "sc01E", "sc01F", "sc020", "sc021", "sc022", "sc023", "sc024", "sc025", "sc026", "sc027", "sc028", "sc02C",
    "sc02D", "sc02E", "sc02F", "sc030", "sc031", "sc032", "sc033", "sc034", "sc035", "sc039"] ; oredred from top-right (`1234 etc.)
...
bind_unbind_layout_layout_switching_keys() {
    ...
    layout_switching_state := n(enable_sequential_layout_switching) && enable_sequential_layout_switching ? "On" :
        "Off"
...
bind_unbind_layout_dedicated_layout_switching_keys() {
    ...
    if (n(enable_dedicated_layout_switching) && n(dedicated_layout_hotkeys) && is_arr(dedicated_layout_hotkeys)) {
        ...
        for (i, dedicated_layout_hotkey in dedicated_layout_hotkeys) {
            Hotkey(dedicated_layout_hotkey, (hotkey) => set_dedicated_with_dedicated_hotkey(hotkey),
            dedicated_layout_switching_state)
        }
    }
}
